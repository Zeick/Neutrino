...
dune_ih = load('Data/mar2018_ih.mat');
exp_nh = load('Data/feb2018_nh.mat');
exp_ih = load('Data/mar2018_ih.mat');
nonunit_nh = load('Data/feb2018_nh.mat');
nonunit_ih = load('Data/mar2018_ih.mat');
...
text2 = text(0.06,1.35,'NSI not from nonunitarity','FontSize',fs); set(text2, 'Rotation', -2);
