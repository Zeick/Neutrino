...
title('Constraints for NSI and trilinear coupling for different M_{\Delta}')
...
h=fill(X,Y,'r');
set(h,'facealpha',.2)
text(xm,0,'Excluded','FontSize',fs)
text(xm,-0.95,'DUNE','FontSize',fs)
text(xm,-2,'New interactions (NSI)','FontSize',fs)
text(xm,-2.8,'Possible nonunitary effects','FontSize',fs)
